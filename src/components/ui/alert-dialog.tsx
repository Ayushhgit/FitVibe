  ...
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ...
      className={cn(
        ...
        "relative z-50 w-full max-w-lg rounded-2xl px-6 py-5 sm:p-8 backdrop-blur-md bg-white/30 dark:bg-neutral-800/30 shadow-2xl overflow-hidden",
        "before:content-[''] before:absolute before:inset-0 before:-z-10 before:rounded-2xl before:p-[1px] before:bg-gradient-to-r before:from-purple-300 before:to-pink-300",
